...
- [Colab](https://colab.research.google.com/drive/1TKVms2ABW8_2KtEqWmhO2OnVxu1O0HPF#scrollTo=j9nBqryEqnEf)
- [Video](https://drive.google.com/file/d/13_T3jhbgSlUHsGYNIZPIJSc2ktPxvt0O/view?usp=sharing)
...
I have selected the R2 score as the primary evaluation metric for the Car Price Prediction model. And after removing the overfitted models which have MSE, R2 score, Adjusted R2 score for the train as 100% and also have a negative accuracy value, we get the final list:
...
- The 'city' model is the top-selling car, followed by the Corolla Altis,' 'Verna,' 'Fortuner,' and 'brio,' providing a snapshot of popular car models in the market.
...
- The 'Owner' count plays a role in car pricing, with 'First Owner' cars being more expensive than 'Second' or 'Third Owner' cars.
